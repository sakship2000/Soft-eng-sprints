...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static JMenuBar createMenuBar() {
        ...
        JMenu menu = new JMenu("Hogwarts Hobo");
        menuBar.add(menu);
    ...
    ***************************************************************************/
    ...
    /**
     * Draws a filled rectangle of the specified size at coordinates (x,y).
     *
     * @param  x the coordinate of the left side of the rectangle
     * @param  y the coordinate of the left side of the rectangle
     * @param  w one half the width of the rectangle
     * @param  h one half the height of the rectangle
     * @throws IllegalArgumentException if either {@code w} or {@code h} is negative
     * @throws IllegalArgumentException if any argument is either NaN or infinite
     */
    public static void fillHealthBar(double x, double y, double w, double h) {
        validate(x, "x");
        validate(y, "y");
        validate(w, "width");
        validate(h, "height");
        validateNonnegative(w, "width");
        validateNonnegative(h, "height");
